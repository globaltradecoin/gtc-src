GlobalTradeCoin-qt: Qt4 GUI for GlobalTradeCoin
===============================
...
Alternatively, install Qt Creator and open the `GlobalTradeCoin-qt.pro` file.

An executable named `GlobalTradeCoin-qt` will be built.
...
A warning for people using the *static binary* version of GlobalTradeCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of GlobalTradeCoin is linked against libdb5.3.
...
installed causes GlobalTradeCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
