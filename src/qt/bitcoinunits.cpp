...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("GlobalTradeCoins"));
    case mBTC: return QString(QObject::tr("Milli-GlobalTradeCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-GlobalTradeCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
