...
unsigned int nStakeMinAge = 8 * nOneHour; // 8hr as zero time weight
unsigned int nStakeMaxAge = 5 * 24 * nOneHour; // 5 days as full weight
...
const string strMessageMagic = "GlobalTradeCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("GlobalTradeCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GlobalTradeCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // GlobalTradeCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GlobalTradeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "GTC Genesis Block Dec 23 2016";
        CTransaction txNew;
        txNew.nTime = 1482538158;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1482538158;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 734397 : 99999999;
       ...
       if (fTestNet && (block.GetHash() != hashgenesisblock)) {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xaebd3256da9fadede9fc4025bfc5dfc3370839c81c8b3b5aab3be0d1d6f0d0a4"));
        if (!fTestNet) {
...
unsigned char pchMessageStart[4] = { 0xbc, 0xf3, 0xe2, 0xe5 };
