...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-net");
...
static const char *strDNSSeed[][2] = {
    {"104.236.248.50", "104.236.248.50"},
    {"107.170.117.243", "107.170.117.243"},
	{"45.55.190.170", "45.55.190.170"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GlobalTradeCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("GlobalTradeCoin-start");
